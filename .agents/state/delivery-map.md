...
- Top blockers: maintainability hotspots and any future explicit V2
  implementation decision.
- Next mission: continue the global queue with ACF-MAINT-001 unless the user
  chooses to start V2VIS-001 implementation from the completed visual plan.
